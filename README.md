# Read Me First
Sample project implementing an FX price handler, newest market price is coming in from MQ feed in CSV format, 
we want to expose the latest received price (per currency pair) via REST.
